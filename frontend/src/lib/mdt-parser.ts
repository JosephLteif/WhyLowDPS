...
const MDT_DUNGEON_MAP: Record<number, string> = {
  ...
  8: 'Sanguine Depths',
  27: 'Tazavesh: Streets of Wonder',
  28: 'Tazavesh: So\'leah\'s Gambit',
  15: 'Freehold',
  16: 'Waycrest Manor',
  17: 'Tol Dagor',
  18: 'The Motherlode!!',
  19: 'Shrine of the Storm',
  20: 'Siege of Boralus',
  21: 'Temple of Sethraliss',
  22: 'The Underrot',
  23: 'Kings\' Rest',
  24: 'Atal\'Dazar',
  25: 'Operation: Mechagon - Junkyard',
  26: 'Operation: Mechagon - Workshop',
  29: 'Algeth\'ar Academy',
  30: 'Brackenhide Hollow',
  31: 'Halls of Infusion',
  32: 'Neltharus',
  33: 'The Azure Vault',
  34: 'The Nokhud Offensive',
  35: 'Uldaman: Legacy of Tyr',
  37: 'Ara-Kara, City of Echoes',
  38: 'City of Threads',
  39: 'The Dawnbreaker',
  40: 'The Stonevault',
  41: 'Mists of Tirna Scithe (TWW)',
  42: 'The Necrotic Wake (TWW)',
  43: 'Siege of Boralus (TWW)',
  44: 'Grim Batol',
};
...
class AceSerializer {
  ...
  private readTable(): any {
    ...
    while (true) {
      ...
      if (key === AceSerializer.END_TABLE || this.tokenIdx > this.tokens.length || key === null)
        break;
